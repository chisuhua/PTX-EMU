...
if [[ "$QUICK" == "true" ]]; then
    ...
    run_regex_tests "test_simt_stack_entry|test_simt_stack_entry_integrated" "BUG-002: SIMT stack exit handling"
    ...
    run_regex_tests "test_barrier_scenarios|test_barrier_scenarios_integrated" "Barrier scenarios (warp_sync/PC protection)"
    run_regex_tests "test_barrier_verification|test_barrier_verification_integrated" "Barrier verification (wbar lifecycle)"
...
run_regex_tests "test_simt|test_simt_stack_entry_integrated|test_simt_thread_pc|test_simt_thread_pc_integrated" "SIMT Stack tests (core + integrated)"
...
run_regex_tests "test_syncthreads_direction" "Syncthreads direction"
...
run_regex_tests "test_warp_barrier_integrated|test_warp_barrier_extended|test_post_barrier_divergence|test_barrier_interaction_integrated" "Barrier warp/interaction (integrated)"
run_regex_tests "test_divergence_sync_standalone|test_divergence_sync_isolated" "Divergence + barrier sync (standalone + isolated)"
