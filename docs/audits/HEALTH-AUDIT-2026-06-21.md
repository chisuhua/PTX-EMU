...
> **⚠️ 8 个事实错误已修正（2026-07-01 ERRATA）** — 详见 [HEALTH-AUDIT-2026-06-21-ERRATA.md](HEALTH-AUDIT-2026-06-21-ERRATA.md)
>
> 主要修正：
> - ThreadContext 字段数（声称 ~50 → 实际 28，含 4 POD）
> - 符号表 27 处泄漏（实际 ~2 处严重）
> - ptx_visitor.cpp ~30 处引用计数错误（实际 ~12 处）
> - 其他 5 项数字偏差
>
> **建议**：阅读本审计时同步阅读 ERRATA 以获取正确数字。
