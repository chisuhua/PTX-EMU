...
def main():
    ...
    parser.add_argument("--mode", type=str, choices=['mode1', 'mode2', 'mode3a', 'mode3b'],
    ...
    file_name = _strip_test_prefix(test_name)
    print(f"\nTo build and run:")
    print(f"  cmake .. && cmake --build build --target test_{file_name}_mode1 test_{file_name}_mode2 test_{file_name}_mode3a test_{file_name}_mode3b")
