...
// PtxVisitor::visitTcgen05Inst (ptx_visitor_wmma.cpp:38-). The outer-X
// VISITOR_TCGEN05_INSTR override lives in ptx_visitor_dispatch.cpp.
...
#include "ptx_visitor_dispatch.cpp"
