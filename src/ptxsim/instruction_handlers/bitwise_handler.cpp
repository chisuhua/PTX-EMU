...
void AND::process_operation(ThreadContext *context, void *dst, void *src1,
...
void OR::process_operation(ThreadContext *context, void *dst, void *src1,
                           void *src2, std::vector<Qualifier> &qualifiers) {
    // 实现OR指令的具体逻辑
    int bytes = TypeUtils::get_bytes(qualifiers);
...
void XOR::process_operation(ThreadContext *context, void *dst, void *src1,
                            void *src2, std::vector<Qualifier> &qualifiers) {
    // 实现XOR指令的具体逻辑
    int bytes = TypeUtils::get_bytes(qualifiers);
...
void SHL::process_operation(ThreadContext *context, void *dst, void *src1,
                            void *src2, std::vector<Qualifier> &qualifiers) {
    // 获取数据类型信息
    int bytes = TypeUtils::get_bytes(qualifiers);
...
void SHR::process_operation(ThreadContext *context, void *dst, void *src1,
                            void *src2, std::vector<Qualifier> &qualifiers) {
    // 获取数据类型信息
    int bytes = TypeUtils::get_bytes(qualifiers);
