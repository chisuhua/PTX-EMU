...
TEST_CASE("integrated_warp_state_exec_mask_after_barrier", "[warp_state][integrated][execute_warp]") {
...
TEST_CASE("integrated_warp_state_all_active_after_convergence", "[warp_state][integrated]") {
    init_instruction_factory_once();
    ResourceManager::instance().initialize(1, 8192);
