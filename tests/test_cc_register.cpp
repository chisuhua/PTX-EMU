...
void test_cc_register() {
    std::cout << "Testing Condition Code Register functionality..." << std::endl;
    ...
    std::cout << "Overflow flag after ADDC: " << context.cc_reg.overflow << std::endl;
    ...
    std::cout << "\nTest 3: ADDC without .cc modifier should not update CC register" << std::endl;
