...
TEST_CASE("Mode3a: test_divergence_sync_standalone - shared memory raw WarpContext", "[mode3a][shared][raw]") {
    init_factory_once();
...
TEST_CASE("Mode3a: test_divergence_sync_standalone - warp divergence raw", "[mode3a][divergence][raw]") {
    init_factory_once();
