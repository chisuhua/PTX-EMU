# Spec: ptxemu-core-library

**Capability**: PTX-EMU `ptxemu_core` CMake 库目标
**Spec 锁定 commit**: CppTLM HSK-8 spec `3b8f7a5` + PTX-EMU ack body `738b412c`
**关联**: ADR-0028 BLOCKING DEPENDENCY upgrade, HSK-6 bridge cleanup (`09786635`)
