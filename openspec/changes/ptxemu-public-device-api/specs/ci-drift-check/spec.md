...
**Capability**: PTX-EMU CI drift_check workflow (公共头一致性 check)
**Spec 锁定 commit**: 本 spec (HSK-8 ack 决策点 2 答复)
**关联**: ptx-lessons-learned §5 (类型判断 fragility), ADR-0028 BLOCKING DEPENDENCY upgrade
