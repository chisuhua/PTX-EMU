...
### Requirement: All 13 tcgen05 PTX fixtures SHALL parse successfully
The system SHALL provide 13 `tests/ptx/tcgen05_*.ptx` files covering all
...
The 13 fixtures are: `tcgen05_alloc.ptx`, `tcgen05_dealloc.ptx`,
`tcgen05_relinquish.ptx`, `tcgen05_ld.ptx`, `tcgen05_st.ptx`,
`tcgen05_cp.ptx`, `tcgen05_cp_multicast.ptx`, `tcgen05_mma.ptx`,
`tcgen05_mma_block_scale.ptx`, `tcgen05_mma_ws.ptx`, `tcgen05_commit.ptx`,
`tcgen05_wait.ptx`, `tcgen05_fence.ptx`.

#### Scenario: test_all_ptx.sh passes 13/13
- **WHEN** `./tests/ptx/test_all_ptx.sh` is run after all 13 fixtures are added
- **THEN** all 13 tcgen05 fixtures parse successfully
