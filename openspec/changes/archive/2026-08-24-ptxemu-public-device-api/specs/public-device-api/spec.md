# Spec: public-device-api

**Capability**: PTX-EMU 端公共设备 API 契约
**Spec 锁定 commit**: CppTLM `3b8f7a5` (HSK-8 spec) + PTX-EMU ack body `738b412c`
**关联**: ADR-0028 BLOCKING DEPENDENCY upgrade
