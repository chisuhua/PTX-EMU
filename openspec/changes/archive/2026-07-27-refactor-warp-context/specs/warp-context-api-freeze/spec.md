# warp-context-api-freeze — Spec

## Purpose

`sm_context.cpp:379/:461/:468/:583/:590` 5 站点消费 `WarpContext` public API。`god-class-refactor-sm-context` change 依赖本 spec 冻结的 API 签名做 SM 侧拆分。
...
- `improvements/refactor-warp-context.md`
- `improvements/god-class-refactor-sm-context.md`：C-2 依赖方