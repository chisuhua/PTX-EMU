# warp-context-simt-orchestration — Spec

## Purpose

`simt_stack.cpp` 数据结构已抽离至 `src/ptxsim/core/simt_stack.cpp`。warp_context.cpp:64-143 残留的 push/pop/check_reconvergence 是**编排逻辑**（divergence/reconvergence handling）。本 spec 定义提取该编排逻辑至独立模块的需求。
...
- `docs/adr/ADR-0006-simt-stack-management.md`
- `docs/adr/ADR-0014-independent-thread-scheduling.md`
- `.opencode/skills/ptx-lessons-learned/SKILL.md:48-77` (§1)