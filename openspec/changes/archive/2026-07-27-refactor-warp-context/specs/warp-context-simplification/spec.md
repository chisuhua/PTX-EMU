# warp-context-simplification — Spec

## Purpose

`WarpContext` 主文件 (`src/ptxsim/core/warp_context.cpp`) 实测 558 行，含执行/状态/同步三类职责混合。本 spec 定义拆分主文件至 ≤ 3 个子模块的需求。
...
- `improvements/refactor-warp-context.md`：完整提案
