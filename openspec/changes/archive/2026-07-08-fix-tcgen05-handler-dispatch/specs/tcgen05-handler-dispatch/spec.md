...
> **前置 spec**: [tcgen05-ir-types](../../../../specs/tcgen05-ir-types/spec.md)
> **关键变更**: 把已经定义的"shall dispatch"意图变为实测的真实 wiring
...
(None — this delta does not modify requirements in any existing spec; it fulfills them.)
...
This delta is the **implementation** of the requirements previously stated as "shall" in `openspec/specs/tcgen05-ir-types/spec.md`. After this change is archived, those "shall" statements become observable system behavior. The corresponding entries in `openspec/specs/tcgen05-ir-types/spec.md` may be marked as "implemented" in a subsequent sync.
