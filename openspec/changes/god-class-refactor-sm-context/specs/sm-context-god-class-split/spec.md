# sm-context-god-class-split — Spec

## Purpose

`sm_context.cpp` 965 行混合 4 类职责：CTA 调度、warp 生命周期、Barrier 集成、ADR-0020 注入编排。本 spec 定义拆分需求。
...
- `improvements/god-class-refactor-sm-context.md`
- `.opencode/skills/ptx-lessons-learned/SKILL.md:474-483` (Checklist B)