...
## Purpose
Defines the embedding of CFG post-dominator analysis results (`reconvergence_pc`) into the PTXIR binary format during generation, enabling the loading path to skip CFG recomputation.
